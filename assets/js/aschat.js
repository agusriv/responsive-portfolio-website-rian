...
const API_KEY = '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'
let data;
...
async function callGPT(inputText){
    await delay(1000)
    let writingItem = document.createElement("li");
        writingItem.textContent = "";
    ...
    console.log(data);
        ...
        chatHistorialContainer.lastChild.remove();
